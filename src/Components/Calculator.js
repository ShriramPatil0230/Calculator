        ...
        <div>
            <div className="calculator-container">
                ...
                <div className='input-fiels'>
                    <input type="text" name="num1" placeholder='Num 1' value={num1} onChange={(e) => {setNum1(e.target.value)}} />
                    <input type="text" name="num2" placeholder='Num 2' value={num2} onChange={(e) => {setNum2(e.target.value)}} />
                </div>
